...
| ~~2.1~~ | ~~Walk-Forward 框架~~ | ~~4 天~~ | ~~中~~ | ✅ 已完成 |
| ~~2.2~~ | ~~Embargo Period~~ | ~~1 天~~ | ~~低~~ | ✅ 已完成 |
| ~~2.3~~ | ~~多市场并发加载~~ | ~~2 天~~ | ~~低~~ | ✅ 已完成 |
| ~~2.4~~ | ~~数据健康检查集成~~ | ~~1 天~~ | ~~低~~ | ✅ 已完成 |
| ~~3.1~~ | ~~行业分类数据完善 + yfinance 动态回退~~ | ~~2 天~~ | ~~中~~ | ✅ 已完成 |
| ~~3.2~~ | ~~多 Alpha 联合组合~~ | ~~5 天~~ | ~~高~~ | ✅ 已完成 |
| ~~3.3~~ | ~~Beta 中性化~~ | ~~3 天~~ | ~~中~~ | ✅ 已完成 |
