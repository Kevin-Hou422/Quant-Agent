...
export default function ChatView() {
  ...
  const activeTitle = sessions.find((s) => s.id === sessionId)?.title ?? 'AI Quant Agent'

  return (
    <div className="flex flex-col h-full bg-slate-950">
      {/* Header */}
      <div className="flex items-center px-4 py-3 border-b border-slate-800 bg-slate-900 shrink-0">
        <div className="min-w-0 flex-1">
          <h2 className="text-sm font-semibold text-slate-200 truncate">{activeTitle}</h2>
